...
\begin{quote}\small
  \textbf{Day \& Time:} Tuesdays \& Thursdays 1:00PM -- 2:15PM\\
 ...
 \textbf{Gradescope Entry Code:} WDBYPK\\
\textbf{Project Presentations:} Monday, December 21 (1:00PM -- 3:00PM)
\end{quote}
...
\textbf{Office:} Sustainable Engineering Laboratories 2M32\\
\textbf{Office Hours:} Tuesdays and Wednesdays (2:30 -- 3:30PM)
\end{quote}
...
\begin{quote}\small
   ...
   \textbf{Office:} Sustainable Engineering Laboratories 2M40\\
   \textbf{Office Hours:} Mondays (1:00 -- 2:00PM) and Fridays (10:00 -- 11:00AM)
   \end{quote}

\subsection{Grader}
The grader  will be responsible for evaluating and assigning grades to problem sets:
...
\begin{table}[h!]
  ...
  \begin{tabular}{l c c c l}\toprule
    ...
    In-Class Activities  & 23 & 1 & 20 & 3 absences excused \\
    % Problem Sets [PS]    & 9  & 45 \\
    Problem Sets [PS] & 10 & 3.5 & 35 &\\
    Labs [LAB] & 10 & 2 & 20 &  \\
    Midterm Exam         & 1 & 8 & 8 &\\
    Final Project   & 1 & 17 & 17 & \\ \midrule
    TOTAL & & & \bf 100 & \\
    \bottomrule
  \end{tabular}
\end{table}
...
During each lecture (there are 23 this semester), there will be an activity to be completed either individually or in a group. Activities will include surveys, short readings, interactive quizzes/polls and/or worksheets.
In order to participate fully, \textbf{please bring your laptop to all lectures}.


\subsection{Problem sets and LABs}
Problem sets (PS) will be assigned weekly and submitted via Gradescope. Assignments are due at 11:59pm \textit{the day after} the date shown in the course schedule: dates shown on a Tuesday are due Wednesday at 11:59pm; dates shown on a Thursday are due Friday at 11:59pm.
...
\begin{table}[h!]\small
	...
	\begin{tabular}{p{1.8cm} p{1.2cm} p{7cm}  p{1.5cm} p{3cm}}\toprule
		...
		Tu, Sep 8 & 1A  & Data and Sampling   & 1 &  \\
		Th, Sep 10 & 1B  & Summarizing Data       & 2          & (No in-person class)\\
		Tu, Sep 15  & 1C & Case Studies and Experiments      & 2  & PS 1 \& LAB 1 due\\
		\midrule
		\rowcolor{gray!30}    \multicolumn{5}{l}{\bf M2 Probability} \\\midrule
		Th, Sep 17  & 2A & Events \& Set Operations          & 3.1    &  \\
		Tu, Sep 22 &  2B & Theory of Probability           & 3.2         &   PS 2 \& LAB 2 due  \\
		Th, Sep 24 & 2C &Conditional Probability \& Bayes' Theorem                 &   3.3-4          &  \\
		\midrule
      \rowcolor{gray!30}    \multicolumn{5}{l}{\bf M3 Probability Distributions} \\\midrule
            Tu, Sep 29 & 3A & Introduction           & 3.5   &  PS 3 \& LAB 3 due  \\
            Th, Oct 1 & 3B & Normal Distribution    & 4.1  &   \\
            Tu, Oct 6 & 3C & Lognormal and Exponential Distributions   & TBD   & PS 4 \& LAB 4 due \\
            Th, Oct 8 & 3D & Binomial Distribution & 4.3 &  \\
            Tu, Oct 13 & 3E & Poisson Distribution         &    4.5        & PS 5 \& LAB 5 due \\
            Th, Oct 15 & 3F & Review/Applications         &          & \\
      \midrule
      Tu, Oct 20 &   & MIDTERM EXAM (Take Home: 2hrs)                &            &  \\
      \midrule
      \rowcolor{gray!30}    \multicolumn{5}{l}{\bf M4 Inference Foundations} \\\midrule
      Th, Oct 22 &  4A & Point Estimates                 &      5.1      &  \\
      Tu, Oct 27  & 4B & Sampling Variability \& Central Limit Thm             & 5.1         & \\
      Th, Oct 29  & 4C & Confidence Intervals for a Proportion     & 5.2          &  {PS 6 \& LAB 6 due} \\
      \rowcolor{gray!30}  Tu, Nov 3 & & NO CLASS (Election Day) &  & \\
      Th, Nov 5  & 4D & Hypothesis Testing for a Proportion                   & 5.3   &  \\
      \midrule
      \rowcolor{gray!30}    \multicolumn{5}{l}{\bf M5 Inference for Categorical Data} \\\midrule
      Tu, Nov 10 & 5A & Inference for Single Proportion       & 6.1        &  {PS 7 \& LAB 7 due}   \\
      Th, Nov 12 & 5B & Difference of Two Proportions       & 6.2        &     \\
      Tu, Nov 17    & 5C & Goodness of Fit Testing (Chi-square)   & 6.3-4   &  {PS 8 \& LAB 8 due} \\\midrule
      \rowcolor{gray!30}    \multicolumn{5}{l}{\bf M6 Inference for Numerical Data} \\\midrule
      Th, Nov 19    & 6A & One-sample means      & 7.1  &   \\
      \rowcolor{gray!30} Tu, Nov 24 &  & NO CLASS (Wednesday schedule followed) & &\\
      \rowcolor{gray!30} Th, Nov 26 &  & THANKSGIVING RECESS & &\\
      Tu, Dec 1  & 6B & Inference with Two Samples      & 7.2-3  &  {PS 9 \& LAB 9 due}  \\
      Th, Dec 3  & 6C & Power and ANOVA             & 7.4-5        &   \\\midrule
            \rowcolor{gray!30} \multicolumn{5}{l}{\bf M7 Linear Regression} \\\midrule
      Tu, Dec 8  & 7A &  Correlation and Least Squares  		             & 8.1-2         & {PS10 \& LAB10 due} \\
      Th, Dec 10  & 7B &  Inference for Regression    & 8.4, 9.1-4  &   \\
		\midrule
		Tu, Dec 15  &       & Review \& Project Q\&A &   &  \\
		\midrule
		Mo, Dec 21  &       & PROJ.\ PRESENTATIONS (1:00--3:00PM) && \\  \bottomrule
	\end{tabular}
