...
\begin{table}[h!]\small
	...
	\begin{tabular}{p{1.8cm} p{1.2cm} p{7cm}  p{1.5cm} p{3cm}}\toprule
		...
		Th, Sep 10 & 1B  & Summarizing Data       & 2          & \\
		Tu, Sep 15  & 1C & Case Studies and Experiments      & 2  & PS 1 due\\
		\midrule
      ...
      Th, Oct 22 &  4A-i & Point Estimates and Sampling Variability                  &      5.1      &  \\
      Tu, Oct 27  & 4A-ii & Point Estimates and Sampling Variability             & 5.1         & \\
      Th, Oct 29  & 4B & Confidence Intervals for a Proportion     & 5.2          &   \\
      \rowcolor{gray!30}  Tu, Nov 3 & & NO CLASS (Election Day) &  & \\
      Th, Nov 5  & 4C & Hypothesis Testing for a Proportion                   & 5.3   & {PS 6 \& LAB 6 due} \\
      \midrule
      \rowcolor{gray!30}    \multicolumn{5}{l}{\bf M5 Inference for Categorical Data} \\\midrule
      Tu, Nov 10 & 5A & Inference for Single Proportion       & 6.1        &     \\
      Th, Nov 12 & 5B & Difference of Two Proportions       & 6.2        &     \\
      Tu, Nov 17    & 5C & Goodness of Fit Testing (Chi-square)   & 6.3-4   &  \\\midrule
      \rowcolor{gray!30}    \multicolumn{5}{l}{\bf M6 Inference for Numerical Data} \\\midrule
      Th, Nov 19    & 6A & One-sample means      & 7.1  &  {PS 7 \& LAB 7 due} \\
      \rowcolor{gray!30} Tu, Nov 24 &  & NO CLASS (Wednesday schedule followed) & &\\
      \rowcolor{gray!30} Th, Nov 26 &  & THANKSGIVING RECESS & &\\
      Tu, Dec 1  & 6B & Inference with Two Samples      & 7.2-3  &   \\
      Th, Dec 3  & 6C & Power and ANOVA             & 7.4-5        &  {PS 8 \& LAB 8 due} \\\midrule
            \rowcolor{gray!30} \multicolumn{5}{l}{\bf M7 Linear Regression} \\\midrule
      Tu, Dec 8  & 7A &  Correlation and Least Squares  		             & 8.1-2         &  \\
      Th, Dec 10  & 7B &  Inference for Regression    & 8.4, 9.1-4  &   \\
		\midrule
		Tu, Dec 15  &       & LAST DAY OF CLASSES / Review \& Project Q\&A &   &  {PS 9 \& LAB 9 due} \\
		\midrule
		Mo, Dec 21  &       & PROJECT PRESENTATIONS (1:00 -- 3:00PM) && \\  \bottomrule
	\end{tabular}
