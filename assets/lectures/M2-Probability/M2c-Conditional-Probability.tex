...
\begin{frame}
  \frametitle{Example 3: Airline industry strikes}\pause
    ...
    \item the probability that all groups will strike in the next 3 years
        \item the probability that none of the groups will strike in the next 3 years
    \item the probability of a labor strike in the airline industry in the next 3 years (i.e., that any of the groups will strike)
    \end{enumerate}
  \end{frame}
...
\begin{frame}
  ...
  \frametitle{Example 3: Airline industry strikes (cont.)} \pause
    ...
    {\bf (b) } The probability that none of the 3 groups will strike in the next 3 years is given by: \pause\pause
    ...
    \item Use the multiplication rule for statistically independent events: \pause
      \begin{eqnarray*}
        P(\ol{A}\,\ol{B}\,\ol{C}) & =&  P(\ol{A})P(\ol{B})P(\ol{C}) \pause \quad \text{\og statistical independence} \\\pause                        
                          &=&  (1-0.03)(1-0.05)(1-0.06) \\\pause
        &=& (0.97)(0.95)(0.94) \\ \pause
        &=& \boxed{0.866}
      \end{eqnarray*}
    \end{enumerate}
...
\begin{frame}
  \frametitle{Example 3: Airline industry strikes (cont.)} \pause
    ...
    {\bf (c) } The probability of a labor strike is the probability that any combination of the groups will strike. \pause
    ...
    \item Realize that this is simply the probability of the complement of the event in which none of the 3 groups strike, which you have already computed. Thus: \pause
      \begin{eqnarray*}
        P(A\cup B \cup C) & =& 1 - P(\ol{A})P(\ol{B})P(\ol{C})  \\ \pause
                          & =& 1 - 0.866 \\ \pause
        &=& \boxed{0.134}
      \end{eqnarray*}
    \end{enumerate}
 ...
 \begin{frame}
  \frametitle{Example 3: Airline industry strikes (cont.)} \pause
    ...
    {\bf (c) } The probability of a labor strike is the probability that any combination of the groups will strike. [ALTERNATE SOLUTION using de Morgan's rule]\pause
    ...
    \item Realize that this is simply the probability of the complement of the event in which none of the 3 groups strike, which you have already computed. Use the complement rule, de Morgan's rule and multiplication rule for statistically independent events: \pause
      \begin{eqnarray*}
