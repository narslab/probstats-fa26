...
\date[September 8, 2026]{\footnotesize September 8, 2026}
\author{{\bf Prof.\ Oke}}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
  \item Fill out the class pre-survey at \url{https://forms.gle/8Am5m39bxoUhRzt19}
...
%       \begin{itemize}
%       \item Office: Sustainable Engineering Laboratories 2M32
%       \end{itemize}
...
\begin{frame}
  \frametitle{Recap}
  \begin{itemize}[<+->]
  \item Course introduction (take \href{https://forms.gle/rzvaVxdujGk1TQiX9}{survey})
