...
\begin{frame}
  \frametitle{Their expectations (Fall 2025)}
  \includegraphics[width=\textwidth]{wordcloud2025}
\end{frame}

\begin{frame}
  \frametitle{Your expectations (Fall 2026)}
  \includegraphics[width=\textwidth]{wordcloud-fa26}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  \item \texttt{m1-blind-stork.ipynb} \url{https://colab.research.google.com/drive/1dhNi0bMTEtlWCozepK24Qk2LElJLtZSt?usp=sharing}
